<template>
  <div
    ...
    :class="[rank === 1 ? 'border-yellow-400 shadow-sm' : rank === 2 ? 'border-gray-300' : rank === 3 ? 'border-orange-300' : 'border-gray-100 hover:border-gray-400']"
  >
    ...
    <div class="flex-1 flex flex-col justify-center min-w-0 overflow-hidden">
      <h3 class="text-xl font-extrabold text-gray-900 leading-tight mb-1 break-keep">애호박</h3>
      <h3 class="text-sm font-bold text-gray-900 leading-tight mb-1 break-keep">
        {{ displayName }}
      </h3>
