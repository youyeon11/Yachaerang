...
CREATE TABLE IF NOT EXISTS farm (
    ...
    cultivated_area DECIMAL(15, 2) NULL,
    flat_area DECIMAL(15, 2) NULL,
...
CREATE TABLE IF NOT EXISTS daily_price (
                                           daily_price_id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS monthly_price (
                                             monthly_product_id BIGINT PRIMARY KEY AUTO_INCREMENT,
                                             product_code VARCHAR(100) NOT NULL,
    price_year INT,
    price_month INT,
    avg_price DECIMAL(15, 2),
...
CREATE TABLE IF NOT EXISTS yearly_price (
                                            yearly_product_id BIGINT PRIMARY KEY AUTO_INCREMENT,
                                            product_code VARCHAR(100) NOT NULL,
    price_year INT,
    avg_price DECIMAL(15, 2),
    min_price DECIMAL(15, 0),
